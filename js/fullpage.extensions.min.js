...
!(function (e, t, n, o, r) {
  ...
  function oo(e, t) {
    e = lo(e) ? e[0] : e;
    for (
      var n = null != t ? Un(t, e.parentNode) : e.parentNode.childNodes,
        o = 0,
        r = 0;
      r < n.length;
      r++
  ...
  function fo(e, t) {
    for (
      "string" == typeof t && (t = Lo(t)), e.appendChild(t);
      e.firstChild !== t;
  ...
  function yo(e, t, n) {
    var o;
    (n = void 0 === n ? {} : n),
      "function" == typeof cn.CustomEvent
    ...
    function (e, b) {
        ...
        b = Fn(
          {
            ...
            scrollOverflowHandler: cn.fp_scrolloverflow
              ? cn.fp_scrolloverflow.iscrollHandler
              : null,
          ...
          w &&
            ...
            (m.test = {
              ...
              translate3dH: (function () {
                for (
                  var e = [], t = 0;
                  t < Un(b.sectionSelector, w).length;
                  t++
                )
            ...
            (function () {
              Kn(w, { height: "100%", position: "relative" }),
                ao(w, un),
                ao(c, hn),
                (y = Qn()),
                co(w, pn),
              ...
              b.fixedElements &&
                ...
                Un('iframe[src*="youtube.com/embed/"]', w).forEach(function (
                  e
                ) {
                  var t, n, o;
                  (n = "enablejsapi=1"),
      ...
      function re(e, t) {
        ...
        if (b.autoScrolling && !b.scrollBar)
          Kn(s, { overflow: "hidden", height: "100%" }),
            ie(V.recordHistory, "internal"),
            Kn(w, { "-ms-touch-action": "none", "touch-action": "none" }),
            null != n && Gt(n.offsetTop);
        else if (
          (Kn(s, { overflow: "visible", height: "initial" }),
          ie(!!b.autoScrolling && V.recordHistory, "internal"),
          Kn(w, { "-ms-touch-action": "", "touch-action": "" }),
          _t(w),
          null != n)
        ) {
        ...
        e
          ? ((function () {
              ...
              var n =
                ...
                o = !!j && { passive: !1 };
              "DOMMouseScroll" == n
                ? sn[e](t + "MozMousePixelScroll", Ye, o)
                : sn[e](t + n, Ye, o);
            })(),
            w.addEventListener("mousedown", pt),
            w.addEventListener("mouseup", ht))
          : (sn.addEventListener
              ? (sn.removeEventListener("mousewheel", Ye, !1),
                sn.removeEventListener("wheel", Ye, !1),
                sn.removeEventListener("MozMousePixelScroll", Ye, !1))
              : sn.detachEvent("onmousewheel", Ye),
        ...
        e
          ? (ce(!0),
            (function () {
              if (
                (r || i) &&
                (!Jt("dragAndMove") || "mouseonly" === b.dragAndMove)
              ) {
                b.autoScrolling &&
                  (g.removeEventListener(R.touchmove, Ie, { passive: !1 }),
                  g.addEventListener(R.touchmove, Ie, { passive: !1 }));
                var e = b.touchWrapper;
                e.removeEventListener(R.touchstart, je),
                  e.removeEventListener(R.touchmove, Ne, { passive: !1 }),
          ...
          : (ce(!1),
            (function () {
              if (r || i) {
                b.autoScrolling &&
                  (g.removeEventListener(R.touchmove, Ne, { passive: !1 }),
                  g.removeEventListener(R.touchmove, Ie, { passive: !1 }));
                var e = b.touchWrapper;
                e.removeEventListener(R.touchstart, je),
                  e.removeEventListener(R.touchmove, Ne, { passive: !1 });
        ...
        if (!_n(w, pn)) {
          ...
          for (var t = Un(yn), n = 0; n < t.length; ++n) {
            var o = t[n],
              r = Un(In, o)[0],
              i = Un(Hn, o);
            b.verticalCentered && Kn(Un(Ln, o), { height: Rt(o) + "px" }),
              Kn(o, { height: Te(o) + "px" }),
          ...
          !l ||
            ...
            wo(b.afterResize) &&
              e &&
              b.afterResize.call(w, cn.innerWidth, cn.innerHeight),
          ...
          : po(t, b.menu + " [data-menuanchor]") &&
            function (e) {
              !Un(b.menu)[0] ||
                ...
                (bo(e), he(this.getAttribute("data-menuanchor")));
            }.call(t, e);
      }
      function Ee(e, t) {
      ...
      function xe(e) {
        ...
        if (i == sn || !i)
          return ue(!0), void (r && b.scrollOverflowHandler.setIscroll(i, !0));
        "touchend" === t &&
          ((X = !1),
          setTimeout(function () {
            X = !0;
              ...
              if (!o) {
                ...
                (t || n) &&
                  (m.shared.isNormalScrollElement ||
                    (ue(!1), r && b.scrollOverflowHandler.setIscroll(i, !1)),
      ...
      function Me(e, t, n) {
        ...
        (c.className = Nn),
          ...
          1 < n &&
            (b.controlArrows &&
              ((l = e),
              (a = [
                Lo('<div class="fp-controlArrow fp-prev"></div>'),
                Lo('<div class="fp-controlArrow fp-next"></div>'),
              ]),
              ho(Un(In, l)[0], a),
            ...
            b.slidesNavigation &&
              (function (e, t) {
                ...
                Kn(n, { "margin-left": "-" + n.innerWidth / 2 + "px" }),
        ...
        var s = Un(zn, e)[0];
        null != s &&
        (0 !== oo(Un(En), yn) || (0 === oo(Un(En), yn) && 0 !== oo(s)))
          ? (Xt(s, "internal"), ao(s, "fp-initial"))
          : ao(t[0], mn);
      }
      function Te(e) {
      ...
      function Oe(e, t) {
        t || null != Un(En)[0] || ao(e, mn),
          ...
          void 0 !== b.sectionsColor[t] &&
            Kn(e, { "background-color": b.sectionsColor[t] }),
          void 0 !== b.anchors[t] &&
      ...
      function Ce() {
        ...
        ao(n, bn),
          ...
          (e = ft()),
          (t = Nt(e.section)),
          (e.section && t && (void 0 === t || oo(t) !== oo(o))) ||
            !wo(b.afterLoad) ||
            Xe("afterLoad", {
              activeSection: n,
              element: n,
        ...
        if (Be(e)) {
          ...
          ($ = n.y),
            ...
            Un(In, t).length && Math.abs(K - q) > Math.abs(J - $)
              ? !a &&
                Math.abs(K - q) > (Jn() / 100) * b.touchSensitivity &&
                (q < K ? v.m.right && ge(t) : v.m.left && me(t))
              : b.autoScrolling &&
                x &&
                Math.abs(J - $) > (cn.innerHeight / 100) * b.touchSensitivity &&
                ($ < J ? Re("down") : J < $ && Re("up"));
        }
      }
      function Be(e) {
      ...
      function Ve(e) {
        var t = e.offsetHeight,
          ...
          o = n,
          r =
            Jt("dragAndMove") && m.dragAndMove.isGrabbing
          ...
          if (
            ...
            Kt("parallax", "apply", i),
              ...
              b.autoScrolling &&
                ...
                ((c = i).isMovementUp
                  ? go(Un(En)[0], Mo(c.activeSection, yn))
                  : ho(Un(En)[0], To(c.activeSection, yn).reverse()),
      ...
      function Fe(e) {
        ...
        return (
          b.autoScrolling && !b.scrollBar
            ? ((t.options = -e), (t.element = Un(fn)[0]))
            : ((t.options = e), (t.element = cn)),
          t
        );
      }
      function _e(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp
            ? go(Un(yn)[0], t.wrapAroundElements)
            : ho(Un(yn)[Un(yn).length - 1], t.wrapAroundElements),
          Gt(Un(En)[0].offsetTop),
          De(),
      ...
      function Je() {
        var e =
          Un(".fp-auto-height")[0] ||
          (be() && Un(".fp-auto-height-responsive")[0]);
        b.lazyLoading &&
          e &&
      ...
      function yt(e) {
        !b.loopHorizontal &&
          b.controlArrows &&
          (xo(Un(Zn, e.section), 0 !== e.slideIndex),
      ...
      function Et(e) {
        ...
        m.continuousHorizontal && m.continuousHorizontal.afterSlideLoads(e),
          ...
          b.slidesNavigation &&
            null != t &&
            (co(Un(Sn, t), mn), ao(Un("a", Un("li", t)[n]), mn)),
          e.localIsResizing ||
            (Kt("parallax", "afterSlideLoads"),
      ...
      function xt(e, t, n) {
        ...
        if (b.css3) {
          ...
          (m.test.translate3dH[t.sectionIndex] = r),
            (Jt("dragAndMove") && void 0 !== t.isInterlockedSlide) ||
              Tt(Un(Bn, e)),
            Kn(Un(Bn, e), Ut(r)),
      ...
      function Bt(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            l =
              (null ==
                (i = Un(Hn + '[data-anchor="' + (o = t) + '"]', (r = n))[0]) &&
                ((o = void 0 !== o ? o : 0), (i = Un(Hn, r)[o])),
              i);
          Wt(n) === S || _n(n, mn)
            ? jt(l)
            : Ze(n, function () {
      ...
      function on(e, t) {
        !b.autoScrolling || b.scrollBar || (e.self != cn && _n(e, Rn))
          ? e.self != cn && _n(e, Rn)
            ? (e.scrollLeft = t)
            : e.scrollTo(0, t)
          : (e.style.top = t + "px");
